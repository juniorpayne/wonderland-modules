...
public class EditorServlet extends ISocialServletBase {
        ...
        throws IOException, ServletException
    {
        if (sheet.getDetails() instanceof TimerSheet) {
            ...
            //((TimerSheet) sheet.getDetails()).setQuestion(question);

            String name = request.getParameter("name");
            ((TimerSheet) sheet.getDetails()).setName(name);

            String autoOpen = request.getParameter("autoOpen");
            ((TimerSheet) sheet.getDetails()).setAutoOpen(Boolean.parseBoolean(autoOpen));
