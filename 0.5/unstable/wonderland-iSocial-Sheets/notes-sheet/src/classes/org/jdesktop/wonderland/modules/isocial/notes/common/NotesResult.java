...
/**
 * Notes result corresponding to NotesSheet
 * @author Jonathan Kaplan <jonathankap@wonderbuilders.com>
 */
@ISocialModel
@XmlRootElement(name="notes-result")
public class NotesResult extends ResultDetails {
    ...
    public List<String> getResultValues(List<String> list, SheetDetails sd) {
        return Collections.singletonList(getNotes());
    }
}
