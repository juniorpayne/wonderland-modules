...
/**
 * Sheet configuration for the set value sheet
 * @author Jonathan Kaplan <jonathankap@wonderbuilders.com>
 */
@ISocialModel
@XmlRootElement(name="set-value-sheet")
public class SetValueSheet extends SheetDetails {
    private static final String TYPE_NAME = "Set Value";
    private static final String TYPE_DESC = "Students may set a value which can be read by future sheets";
