...
function microphone_recorder_events()
{
  ...
  /*if(a==2) {
      arguments[0]="save_pressed";
  } else if(a==3) {
      arguments[0]="saving";
  } else if(a==4) {
      arguments[0]="save_progress";
  } else if(a==5) {
      arguments[0]="saved";
  }*/
  ...
  case "no_microphone_found":
      $('#status').text("No Microphone Found");
    break;
  ...
  case "recording":
        ...
        Recorder.hide();
        $('#record_button img').attr('src', 'html/images/stop.png');
        $('#play_button').hide();
  ...
  case "recording_stopped":
    ...
    Recorder.show();
    $('#record_button img').attr('src', 'html/images/record.png');
    $('#play_button').show();
    document.getElementById("save_instruction").style.display = "block";
    break;
  ...
  case "playing":
    ...
    var name = arguments[1];
    $('#record_button img').attr('src', 'html/images/record.png');
    $('#play_button img').attr('src', 'html/images/stop.png');
    break;
  ...
  case "stopped":
    ...
    var name = arguments[1];
    $('#record_button img').attr('src', 'html/images/record.png');
    $('#play_button img').attr('src', 'html/images/play.png');
    break;
  ...
  connect: function(name, attempts) {
    ...
    if(Recorder.recorder && Recorder.recorder.init) {
      ...
      if(Recorder.uploadFormId && $) {
        ...
        //fname=new Date().getTime()+".wav";
        
        Recorder.recorder.init(frm.attr('action').toString()+"?fname="+fname, Recorder.uploadFieldName, frm.serializeArray());
      }
      return;
    }
