 ...
 */
package org.jdesktop.wonderland.modules.isocial.generic.web;
...
/**
 * Servlet that handles editing for the generic sheet
...
public class EditorServlet extends ISocialServletBase {
        ...
        throws IOException, ServletException
    {
        if (sheet.getDetails() instanceof GenericSheet) {
            ...
            //((GenericSheet) sheet.getDetails()).setQuestion(question);

            String name = request.getParameter("name");
            ((GenericSheet) sheet.getDetails()).setName(name);

            String autoOpen = request.getParameter("autoOpen");
            ((GenericSheet) sheet.getDetails()).setAutoOpen(Boolean.parseBoolean(autoOpen));
