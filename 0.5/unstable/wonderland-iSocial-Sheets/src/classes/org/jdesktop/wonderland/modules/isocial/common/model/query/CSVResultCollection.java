...
public class CSVResultCollection {
    private final List<CSVResultSheet> sheets = new ArrayList<CSVResultSheet>();
     ...
     */
    public CSVResultCollection(Collection<CSVResultSheet> sheets) {
        this.sheets.addAll(sheets);
    }

    @XmlElementRef
    public List<CSVResultSheet> getSheets() {
        return sheets;
    }
}
