...
/**
 * Double for use in CohortState
 * @author Jonathan Kaplan <jonathankap@wonderbuilders.com>
 */
@ISocialModel
@XmlRootElement(name="cs-double")
public class CSDouble extends CohortStateDetails {
    ...
    public static CSDouble valueOf(Double value) {
